...
export function FeatureSection() {
    return (
        <section className="container bg-gray-700 grid md:grid-cols-2 pb-8 pt-8 md:py-10 gap-4">
            <div className="flex flex-col gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
                <span className="text-blue-200 bg-blue-400 px-2 py-1 w-fit rounded-sm text-body-tag uppercase" >
                    Simples
                </span>
            ...
            <div className="col-span-full flex flex-cil gap-2">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
                    <div className="flex flex-col gap-4 ">
                        ...
                        <Button asChild className="w-fit hidden md:flex lg:flex rounded-full mt-4 md:mt-auto ">
                    ...
                    <div className="flex flex-col items-center justify-center w-full">
                        <div className="w-full max-w-md overflow-hidden">
                            <Image className="object-cover w-full" src="/feature-section.svg" alt={"features"} width={440} height={330} />
                        </div>
                        <Button asChild className="w-full md:hidden lg:hidden rounded-full mt-4 md:mt-auto ">
                            <Link href="./criar-loja">
                                Criar loja grátis
                                <ArrowRight />
                            </Link>
